[portfolio (1).html](https://github.com/user-attachments/files/30647027/portfolio.1.html)
<!DOCTYPE html>
<html lang="ko">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <section id="projects">
        ...
        <div class="card">
            ...
            <ul>
                <li><strong>배경 및 목표:</strong> (예시) NBA 선수들의 기록과 팀 승률 간의 상관관계를 파악하여 핵심 승리 요인 도출</li>
    ...
    <section id="experience">
        ...
        <div class="card">
            ...
            <ul>
                <li><strong>기간:</strong> YYYY.MM ~ 현재</li>
